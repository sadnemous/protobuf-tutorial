...
|6|Cloned another repo from github [solo-io/protoc-gen-openapi](https://github.com/solo-io/protoc-gen-openapi)<br><pre> git clone https://github.com/solo-io/protoc-gen-openapi.git <br> cd protoc-gen-openapi <br> make build and there was a hiccup check note-6 below <br> cp ./_output/.bin/protoc-gen-openapi ~/go/bin/
<br> cd protobuf-tutorial/ <br> ./genProto.sh</pre>|Failed, this proto-gen-openapi does not support proto-3.. Ben Stokes!!| updated proto file
